...
# src/carlogtt_python_library/aws_boto3/kms.py
...
# Type aliases
KMSClient = mypy_boto3_kms.client.KMSClient


class KMS(aws_service_base.AwsServiceBase[KMSClient]):
    """
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            aws_service_name="kms",
            exception_type=exceptions.KMSError,
        )
